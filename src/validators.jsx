...
const dobRegex = new RegExp(/(0[1-9]|1[012])[- \/.](0[1-9]|[12][0-9]|3[01])[- \/.](19|20)\d\d/)
...
export const dobValidator = value => !value ? "Date of Birth is required." : dobRegex.test(value) ? "" : "Not a valid Date of Birth.";
